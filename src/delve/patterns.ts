...
export type Pattern = { id: string; quality: 'good' | 'poor' | 'contextual'; gates: Gate[]; rewards: Reward[] };
...
export const DELVE_PATTERNS: Pattern[] = [
  ...
  { id: 'StrongEnemyTinyPotion', quality: 'poor', gates: [strong], rewards: [{ kind: 'potion' }] },
  ...
  { id: 'PotionBranch', quality: 'contextual', gates: [yellow], rewards: [{ kind: 'potion' }, { kind: 'potion' }] },
